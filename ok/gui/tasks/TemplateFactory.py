...
def _parse_pyi_functions(pyi_path: str) -> List[Dict]:
    ...
    def _get_category(name: str) -> str:
        ...
        if any(w in name_lower for w in ['run', 'on_', '_init', 'exit', 'check_interval', 'should_trigger', '_set_executor']):
            return "Skip"
